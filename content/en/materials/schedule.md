...
**Prepare** by starting [HW 1](/en/materials/homework/hw1-git-basics). You do **not** need to finish the homework and class will be used for troubleshooting and other questions.
