...
Demonstration: programmatic data downloads
...
- Live coding examples: APIs
- Description of HW 8: Data and APIs

##### Wed 11/18

HW 8 work/help session
...
- Description of HW 9: Using ggplot
...
**Submit** dataset for final project via final project repo (or other method arranged in advance for large datasets)
HW 9 work/help session

##### Wed 12/2

- Live coding examples: mapping in R using `sf` and `tmap`
- Description of HW 10: Mapping in R

**Submit HW9 by 5pm EST on Friday, Dec 4.**
