...
- [Chapter 3](https://socviz.co/makeplot.html) of Kiernan Healy's [Data Visualization](https://socviz.co/) book walks through the logic of constructing a graph in ggplot. It introduces you to fewer options than the second reference but does a better job of explaining the logic of ggplot (and the grammar of graphics in general). 
